...
import { LayoutGrid, PlusSquare, Users, BarChart2, Bell, User, LogOut } from "lucide-react";
  ...
  return (
    <aside className="w-64 bg-[#111827] text-gray-100 min-h-screen p-4">
      ...
      <div className="flex items-center gap-3 px-2 py-3">
        <div className="h-9 w-9 flex items-center justify-center rounded-md bg-blue-600 font-bold">SS</div>
        <div>
      ...
      <nav className="mt-6 space-y-1">
        ...
        <NavLink to="/organization/post" className={linkCls}>
