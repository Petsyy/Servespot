...
//       </h3>
//       <p className="text-center text-gray-600 mb-5 justify-center max-w-2xl mx-auto">
//         ServeSpot connects passionate individuals with meaningful
//         micro-volunteering opportunities, making it easy to contribute to causes
//         you care about.
//       </p>
