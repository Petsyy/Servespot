...
import { Bell, CheckCircle, AlertCircle, Info, ExternalLink, BellRing } from "lucide-react";
...
export default function Notifications({ items = [], loading, onMarkAllRead, onMarkRead, maxItems = 3 }) {
  ...
  const getNotificationIcon = (type) => {
    switch (type?.toLowerCase()) {
      ...
      default: return <Info size={18} className="text-green-500" />;
    }
  };
          ...
          {items.length > 0 && (
            <div className="pt-4 border-t border-green-100">
              <div className="flex items-center justify-between">
                ...
                <button 
                  onClick={() => window.location.href = '/organization/notifications'}
