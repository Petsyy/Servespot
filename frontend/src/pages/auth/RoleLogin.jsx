        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl w-full">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col items-center text-center">
            ...
            <div className="w-full flex flex-col gap-3">
              <button className="w-full bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-lg font-medium transition cursor-pointer">
                Log in as Volunteer
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col items-center text-center">
            ...
            <div className="w-full flex flex-col gap-3">
              <button className="w-full border border-green-600 text-green-600 py-2 px-4 rounded-lg font-medium transition mt-6 hover:bg-green-50 cursor-pointer">
