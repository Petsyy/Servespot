      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-100 hover:bg-blue-200 text-blue-700 font-medium transition-all duration-200"
            >
              <ArrowLeft size={18} />
            </button>
            <div>
              ...
              <p className="text-gray-600 text-sm">
                View and update your personal details, preferences, and skills.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            <Section title="About & Preferences" icon={<BadgeInfo size={18} />}>
              <Area
                label="Bio"
                value={me.bio}
                editable={isEditing}
